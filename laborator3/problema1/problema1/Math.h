...
class Math {
  public:
    ...
    static char* Add(const char*, const char*); // will allocate memory that can add the two existing strings. If one of
                                                // the strings is nullptr, this function will return nullptr;
};